...
![/image/golang_virtual_memory.png](/image/golang_virtual_memory.png)
...
![/image/golang_bitmap_1.png](/image/golang_bitmap_1.png)

bitmap中的byte和arena的对应关系从末尾开始, 也就是随着内存分配会向两边扩展:

![/image/golang_bitmap_arena.png](/image/golang_bitmap_arena.png)
...
![/image/golang_spans.png](/image/golang_spans.png)
...
![/image/golang_span_construction.png](/image/golang_span_construction.png)
...
![/image/golang_mcache.png](/image/golang_mcache.png)
...
![/image/golang_new_object.png](/image/golang_new_object.png)
...
![/image/golang_memory_detail.png](/image/golang_memory_detail.png)
...
![/image/golang_flow_graph.png](/image/golang_flow_graph.png)
